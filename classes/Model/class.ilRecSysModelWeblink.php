 ...
 */
 ...
 class ilRecSysModelWeblink extends ilRecSysModelMaterialSection {
    ...
    public function __construct($weblink_id, $obj_id, $difficulty, $rating_count, $no_tags) {
        parent::__construct($weblink_id, $obj_id, $difficulty, $rating_count, $no_tags);
    }
    ...
    public function createMaterialSection() {
        $this->ilDB->manipulateF("INSERT INTO ".self::MATERIALTABLENAME
                . "(weblink_id, obj_id, difficulty, rating_count, no_tags)"
                . " VALUES (%s,%s,%s,%s,%s)",
