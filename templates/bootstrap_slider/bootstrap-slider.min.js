...
========================================================= */
"use strict";
var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:
    function(a){
...
!function(a){
    if("function"==typeof define&&define.amd)define(["jquery"],a);
        ...
        var b;try{b=require("jquery")}catch(c){b=null}module.exports=a(b)
    }
            ...
            function c(b){
                ...
                a.fn[b]=function(e){
                    if("string"==typeof e){
                        ...
                        }return this}var m=this.map(function(){
                            var d=a.data(this,b);
                ...
                for(var e=Object.keys(this.defaultOptions),f=0;f<e.length;f++){
                    ...
                    if(this.sliderElem)p=!0;
                        ...
                        if(this.tickLabels=[],Array.isArray(this.options.ticks_labels)&&this.options.ticks_labels.length>0)for(this.tickLabelContainer=document.createElement("div"),this.tickLabelContainer.className="slider-tick-label-container",f=0;f<this.options.ticks_labels.length;f++){
                            var B=document.createElement("div"),C=0===this.options.ticks_positions.length,D=this.options.reversed&&C?this.options.ticks_labels.length-(f+1):f;B.className="slider-tick-label",B.innerHTML=this.options.ticks_labels[D],this.tickLabels.push(B),this.tickLabelContainer.appendChild(B)
                        }
                        var E=function(a){
